...
if ($year == NULL || $make == NULL || $model == NULL || $price == NULL || $type_id == NULL || $type_id == FALSE || $class_id == NULL || $class_id == FALSE) {
$error = "Invalid vehicle data. Check all fields and try again.";
include('errors/error.php');
} else {
add_vehicle($year, $make, $model, $price, $type_id, $class_id);
header("Location: .");
}
